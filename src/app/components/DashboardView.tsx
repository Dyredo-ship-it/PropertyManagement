...
import { ReminderChainKanban } from "./ReminderChainKanban";
import {
...
function AdminDashboard({
  ...
  return (
    <div className="page-shell">
      ...
      {/* ── Reminder chain kanban (escalation: Rappel 1 → Poursuite) ─ */}
      ...
      <div className="dash-two-col" style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 24 }}>
        ...
        {/* ── Right sidebar: Timeline + To-Do + Buildings ── */}
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>

          {/* ═══ UPCOMING TIMELINE (annual) ═══ */}
          <UpcomingTimeline />
