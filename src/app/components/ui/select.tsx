...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position={position}
      className={cn(
        // ✅ Always on top of Dialog / overlays
        "z-[9999]",
        // ✅ Opaque background so underlying form text never shows through
        ...
        // ✅ Layout
        "relative max-h-[var(--radix-select-content-available-height)] min-w-[8rem] overflow-hidden rounded-md border shadow-2xl",
        position === "popper" &&
